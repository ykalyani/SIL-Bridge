...
<head>
    <meta charset="utf-8">
    <title>Welcome to SIL-Bridge</title>
...
<div class="navbar navbar-fixed-top">
    <div class="navbar-inner">
        <div class="container"> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"><span
                class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span> </a><a class="brand" href="index.html">SIL-Bridge</a>
            <div class="nav-collapse">
                <ul class="nav pull-right">
                    ...
                    <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i
                            class="icon-user"></i> Kirishanthy <b class="caret"></b></a>
                        <ul class="dropdown-menu">
...
<div class="subnavbar">
    <div class="subnavbar-inner">
        <div class="container">
            <ul class="mainnav">
                <li class="active"><a href="/sil-web/index"><i class="icon-dashboard"></i><span>Home</span> </a> </li>
                <li><a href="reports.html"><i class="icon-list-alt"></i><span>Project</span> </a> </li>
...
<div class="footer">
    <div class="footer-inner">
        <div class="container">
            <div class="row">
                <div class="span12"> &copy; 2013 <a href="http://www.egrappler.com/">SIL-Bridge </a>. </div>
                <!-- /span12 -->
            </div>
            <!-- /row -->
        </div>
